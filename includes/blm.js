...
document.write("<h2>Statement Against White Supremacy</h2></header>");
document.write("<font color='#B9A44E'><h2>Stop Asian and NHPI Hate</font></h2>");
document.write("<p>We condemn acts of violence against Asian, Asian American, Native Hawai’ian, and Pacific Islander communities, which have escalated with increasingly widespread racism and xenophobia during the COVID-19 pandemic. We stand in solidarity with Asian, Asian American, Native Hawaiian, and Pacific Islander communities and demand justice for all those who suffer at the hands of white supremacy.</p>")
document.write("<font color='#B9A44E'><h2>Black Lives Matter</font></h2>");
